...
export const portfolioData = [
  {
    ...
    backendDesc: `We are transitioning from a Monolith to a more Microservice approach. Some services are now ran with Docker. With a goal of having our Microservices containerized and running in Kubernetes.
  ...
  For the DataScience side of the coin we use Python along with a Flask API. I won’t waste time name droping all of the DataScience tools and libraries we utilize as this is not my area of experteise. However; I have pitched in on the Flask API and helped on and off with things such as (architecture, preformance, deployment, debugging, scripting).`,
    frontendDesc: `On the frontend we are using React, along with TypeScript to handle the data and deliver rich user tailored expierences for our clients.  Your data Internal Memory, available to recall and curate a more personalized view into the inner workings of either your business or your brain in real-time.`,
    devOpsDesc: `Our current cloud provider is Digital Ocean. We have some automation scripts in place to pull in the new code, run some tests, re-build, and deploy. 
  ...
  },
  {
    ...
    backendDesc: `This one is super simple.  I've hosted it on netlify and setup a simple CI/CD with github main branch.  In the future when I have a little more spare time, I'll put this up on Digital Ocean and use Caddy to serve it up.`,
